...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 5
    answer = count_cosines_from(3, 15, 0.25)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(1, 6, 0.3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 3
    answer = count_cosines_from(5, 7, 0.1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 8
    answer = count_cosines_from(2, 20, 0.25)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(3, 6, 0.24)
